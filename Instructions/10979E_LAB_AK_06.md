...
1. Start Microsoft Edge, browse to **http://portal.azure.com**, and if prompted, sign in by using the Microsoft account that is the Service Administrator of your Azure subscription.
...
1. In the Microsoft Edge window displaying the Azure portal, in the **Search resources, services, and docs** text box, type **10979E0301-vm**, and then click the Virtual machine **10979E0101-VM**.
...
1. Start Internet Explorer, browse to [**http://portal.azure.com**](http://portal.azure.com), and, if prompted, sign in by using the Microsoft account that is the Service Administrator of your Azure subscription.

1. In the Internet Explorer window displaying the Azure portal, in the hub menu, click **Resource groups**.
...
1. In the Remote Desktop session window, click **Start**, in the Start menu, click the **Microsoft SQL Server Tools 17** folder, and click the **Microsoft SQL Server Management Studio 17** shortcut.
...
1. If the connection attempt fails indicating that the client IP address is not allowed to access the server, note the IP address in the error message. Switch to the Azure portal displayed in the Internet Explorer window and, on the **Firewall settings** blade, create a new rule by specifying the following settings and then clicking **Save**:
...
1. Close SQL Server Management Studio and Internet Explorer. Do not save changes when prompted.
...
1. Repeat steps 3 to 5 to delete the **10979E0602-LabRG** and **10979E0301-LabRG** resource groups.
