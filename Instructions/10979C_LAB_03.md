...
1.   Start Internet Explorer and browse to  **http://portal.azure.com**. Sign in to the Azure Portal as the Service Administrator or a Co-Administrator of your Azure subscription.
...
1.   In the Internet Explorer window, in the Azure Portal, from the  **labvm1** blade, establish an RDP connection to the **labvm1** VM by using the following credentials:
...
7.   From the Azure Portal, stop labvm1.
